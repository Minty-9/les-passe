...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .box { background:var(--bg2); border:1px solid var(--border); border-radius:var(--rl); padding:32px; width:100%; max-width:400px; position:relative; z-index:1; }
    ...
    .register-link { text-align:center; font-size:13px; color:var(--muted); margin-top:16px; position:relative; z-index:1; }
    .register-link a { color:var(--greent); text-decoration:none; }
